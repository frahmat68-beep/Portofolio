...
export default function ServicesSection() {
  ...
  return (
    <section className="w-full max-w-2xl mx-auto px-4 py-6" id="services">
      
      {/* Header */}
      <div className="flex items-center justify-between mb-4">
        <div>
          <h2 className="text-lg sm:text-xl font-bold font-display text-white flex items-center gap-2">
            <Sparkles className="w-5 h-5 text-cinemaAmber" />
            <span>Production Services & Scope</span>
          </h2>
          <p className="text-xs text-gray-400">
            Keahlian produksi yang siap dieksekusi untuk proyek lu
          </p>
        </div>
        ...
        {services.map((service, index) => {
          ...
          return (
            <motion.div
              ...
              className="glass-panel-interactive rounded-3xl p-5 flex flex-col justify-between"
            >
              <div>
                {/* Top Badge & Icon */}
                <div className="flex items-center justify-between mb-3">
                  <div className="p-2.5 rounded-2xl bg-cinemaAmber/10 border border-cinemaAmber/20 text-cinemaAmber">
                ...
                <h3 className="text-sm sm:text-base font-bold font-display text-white mb-1.5">
                  {service.title}
                </h3>
                ...
                {service.deliverables && service.deliverables.length > 0 && (
                  <div className="space-y-1.5 mb-4 pt-2 border-t border-white/5">
